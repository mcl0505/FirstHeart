...
public class MySaveOffAdapter extends RefreshAdapter<CollectionRoomListBean.DataBean.OffBean> {
    private Context context;
    private View.OnClickListener mOnClickListener;

    public MySaveOffAdapter(Context context) {
        super(context);
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        void setData(CollectionRoomListBean.DataBean.OffBean bean, int position) {
