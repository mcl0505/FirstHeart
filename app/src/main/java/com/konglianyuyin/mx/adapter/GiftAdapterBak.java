 ...
 * 描述:礼物的列表
 */
public class GiftAdapterBak extends RecyclerView.Adapter<GiftAdapterBak.VH> {
    ...
    public GiftAdapterBak(Context context, MiniCircleRecyclerView recyclerView, List<GiftListBean.DataBean.GiftsBean> data, boolean needLoop) {
