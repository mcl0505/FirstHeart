 ...
 */
@ActivityScope
public class RankAdapterNewTop3 extends BaseQuickAdapter<Rank.DataBean.TopBean, BaseViewHolder> {
    private int type;
    private Context context;
    boolean mIsFirstTransion = true;
    BaseViewHolder mHelper;

    public RankAdapterNewTop3(int type, Context context) {
        super(R.layout.item_rank_new_top3, new ArrayList<>());
        this.type = type;
        this.context = context;
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, Rank.DataBean.TopBean item) {
        mHelper = helper;
