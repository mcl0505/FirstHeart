...
public class GiftUserAdapter extends RecyclerView.Adapter<GiftUserAdapter.VH> {
    ...
    public GiftUserAdapter(Context context, RecyclerView recyclerView,
...
//                    }
        ...
        if (position == 0) {
            ...
            holder.tv.setBackground(context.getResources().getDrawable(R.drawable.shape_room_gif_tingzhu));
        }
//        else if(position == 1){
...
//            holder.tv.setText(position % data.size() - 1 + "");
            ...
            if (data.get(position).getSex() == 1) {
                ...
                holder.tv.setBackground(context.getResources().getDrawable(R.drawable.shape_room_gif_tingmeiren));
            }
        }
