 ...
 * 描述:礼物的列表
 */
public class BaoshiAdapter extends RecyclerView.Adapter<BaoshiAdapter.Vh> {

    private Context context;
    private List<GiftListBeanNew.DataBean.BaoshiBean> mList;
    ...
    public List<GiftListBeanNew.DataBean.BaoshiBean> getData() {
        return mList;
    }


    public BaoshiAdapter(Context context, LayoutInflater inflater, List<GiftListBeanNew.DataBean.BaoshiBean> list) {
        ...
        mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tag != null) {
                    ...
                    GiftListBeanNew.DataBean.BaoshiBean bean = mList.get(position);
                    if (!bean.isChecked()) {
                        if (!cancelChecked()) {
    ...
    public boolean cancelChecked() {
        if (mCheckedPosition >= 0 && mCheckedPosition < mList.size()) {
            GiftListBeanNew.DataBean.BaoshiBean bean = mList.get(mCheckedPosition);
            if (bean.isChecked()) {
                View view = bean.getView();
                if (mAnimView == view) {
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        void setData(GiftListBeanNew.DataBean.BaoshiBean bean, int position, Object payload) {
            if (payload == null) {
    ...
    public interface ActionListener {
        ...
        void onItemChecked(GiftListBeanNew.DataBean.BaoshiBean bean, int postion);
    }
}
