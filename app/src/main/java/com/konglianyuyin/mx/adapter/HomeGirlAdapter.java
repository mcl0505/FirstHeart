 ...
 */
@ActivityScope
public class HomeGirlAdapter extends MyBaseAdapter<StartLoftBean.DataBean> {

    private Context context;
    private CategorRoomBean categorRoomBean;
    public HomeGirlAdapter(Context context, CategorRoomBean categorRoomBean) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final ViewHolder VH;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_home_girl, null);
