 ...
 * 描述:礼物的列表
 */
public class BeibaoAdapter extends RecyclerView.Adapter<BeibaoAdapter.Vh> {

    private Context context;
    private List<GiftListBeanNew.DataBean.MyWaresBean> mList;
    ...
    public List<GiftListBeanNew.DataBean.MyWaresBean> getData() {
        return mList;
    }


    public BeibaoAdapter(Context context, LayoutInflater inflater, List<GiftListBeanNew.DataBean.MyWaresBean> list) {
        ...
        mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tag != null) {
                    ...
                    GiftListBeanNew.DataBean.MyWaresBean bean = mList.get(position);
                    if (!bean.isChecked()) {
                        if (!cancelChecked()) {
    ...
    public boolean cancelChecked() {
        if (mCheckedPosition >= 0 && mCheckedPosition < mList.size()) {
            GiftListBeanNew.DataBean.MyWaresBean bean = mList.get(mCheckedPosition);
            if (bean.isChecked()) {
                View view = bean.getView();
                if (mAnimView == view) {
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        void setData(GiftListBeanNew.DataBean.MyWaresBean bean, int position, Object payload) {
            if (payload == null) {
                ...
                if (bean.getPrice_004() == 0) {
                    mPrice.setText(bean.getPrice());
                    mStone.setVisibility(View.GONE);
                } else {
                    mPrice.setText(String.valueOf(bean.getPrice_004()));
                    mStone.setVisibility(View.VISIBLE);
                }
            }
            mShuliang.setText("x " + bean.getNum());
    ...
    public interface ActionListener {
        ...
        void onItemChecked(GiftListBeanNew.DataBean.MyWaresBean bean, int postion);
    }
}
