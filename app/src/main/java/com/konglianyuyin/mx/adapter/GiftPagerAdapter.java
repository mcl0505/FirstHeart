...
public class GiftPagerAdapter extends PagerAdapter {
    ...
    public GiftPagerAdapter(Context context, List<GiftListBeanNew.DataBean.GiftsBean> giftList) {
        ...
        for (int i = 0; i < pageCount; i++) {
            ...
            List<GiftListBeanNew.DataBean.GiftsBean> list = new ArrayList<>();
            for (int j = fromIndex; j < endIndex; j++) {
                GiftListBeanNew.DataBean.GiftsBean bean = giftList.get(j);
                bean.setPage(i);
                list.add(bean);
            }
            GiftAdapter adapter = new GiftAdapter(context, inflater, list);
    ...
    public interface ActionListener {
        void onItemChecked(GiftListBeanNew.DataBean.GiftsBean bean, int position);
    }
